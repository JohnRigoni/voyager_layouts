...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    TD(DANCE_0),    LT(2,KC_Z),     MT(MOD_LALT, KC_X),MT(MOD_LGUI, KC_C),MT(MOD_LCTL, KC_V),KC_B,                                           KC_N,           MT(MOD_RCTL, KC_M),MT(MOD_RGUI, KC_COMMA),MT(MOD_RALT, KC_DOT),LT(4,KC_SLASH), TD(DANCE_1),    
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, TD(DANCE_2),    TD(DANCE_3),    MT(MOD_LGUI, KC_MINUS),TD(DANCE_4),    KC_CIRC,                                        KC_GRAVE,       TD(DANCE_6),    MT(MOD_RGUI, KC_LBRC),MT(MOD_RALT, KC_RBRC),KC_BSLS,        KC_TRANSPARENT, 
                                                    TD(DANCE_5),    KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [2] = LAYOUT_voyager(
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_NO,          KC_MS_WH_UP,    KC_MS_BTN3,     KC_MS_WH_DOWN,  KC_NO,                                          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
};
